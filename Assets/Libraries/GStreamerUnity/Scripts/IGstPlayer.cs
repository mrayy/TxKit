...
public abstract class IGstPlayer {
	...
	[DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
	extern static private bool mray_gst_PlayerSetPosition(System.IntPtr p,long  pos);

	[DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
	extern static private long  mray_gst_PlayerGetPosition(System.IntPtr p);

	[DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
	extern static private long  mray_gst_PlayerGetDuration(System.IntPtr p);

	[DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
	extern static private System.IntPtr mray_gst_PlayerGetLastImage(System.IntPtr p,int index);

	[DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
	extern static private ulong mray_gst_PlayerGetLastImageTimestamp(System.IntPtr p,int index);

	[DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
	extern static private void mray_gst_PlayerSendRTPMetaToHost(System.IntPtr p,int index,[MarshalAs(UnmanagedType.LPStr)]string ip, int port);


	[DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
	extern static private int mray_gst_PlayerRTPGetEyeGazeLevels(System.IntPtr p,int index);
	[DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
	extern static private void mray_gst_PlayerRTPGetEyeGazeData(System.IntPtr p,int index,int level,ref int x,ref int y,ref int w,ref int h);
	...
	public int RTPGetEyegazeLevels(int index)
	{
		return mray_gst_PlayerRTPGetEyeGazeLevels (m_Instance, index);
	}
	public Vector4 RTPGetEyegaze(int index,int level)
	{
		int x=0, y=0, w=0, h=0;
		mray_gst_PlayerRTPGetEyeGazeData(m_Instance,index,level, ref x,ref y,ref w,ref h);
